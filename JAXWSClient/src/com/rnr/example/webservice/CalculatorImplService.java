 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://webservice.example.rnr.com/", wsdlLocation = "http://localhost:8081/WS/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://webservice.example.rnr.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/WS/Calculator?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://webservice.example.rnr.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.example.rnr.com/", "CalculatorImplPort"), Calculator.class, features);
    }
